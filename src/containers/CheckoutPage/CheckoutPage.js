...
export class CheckoutPageComponent extends Component {
  ...
  loadInitialData() {
    ...
    if (shouldFetchSpeculatedTransaction) {
      ...
      const {units, seats,unitType, customPackages} = pageData.bookingData;
  ...
  handlePaymentIntent(handlePaymentParams) {
    ...
    const orderParams = {
      ...
      units: pageData.bookingData ? pageData.bookingData.units : null,
      seats: pageData.bookingData ? pageData.bookingData.seats : null,
      unitType: pageData.bookingData ? pageData.bookingData.unitType : null,
      customPackages: pageData.bookingData && pageData.bookingData.customPackages?pageData.bookingData.customPackages: null,
