...
import svgIcon from '../../assets/svg-contactinfo.svg';
    ...
    <Page title={title} scrollingDisabled={scrollingDisabled}>
      <LayoutSideNavigation>
        ...
        <LayoutWrapperMain>
          ...
          <UserNav selectedPageName="ContactDetailsPage" rootClassName="gh-leftnav"/>
          ...
          <div className={css.formContainer}>
            <h4 className={css.subTitle}>
              ...
              <img src={svgIcon} alt="contact info" width="41"/>
            </h4>
            {contactInfoForm}
          </div>
          </div>
