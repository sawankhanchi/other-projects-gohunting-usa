    ...
    <div className={classes}>
      ...
      <div className={css.topBorderWrapper}>
        <div className={css.content}>
          <div hidden className={css.someLiksMobile}>{socialMediaLinks}</div>
          <div className={css.links}>
            ...
            <div className={css.infoLinks}>
              <ul className={css.list}>
                ...
                <li className={css.listItem}>
                  <NamedLink name="BlogPage" to={{ hash: '' }} className={css.link}>
              ...
              <ul className={css.list}>
                ...
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchTexas" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchNorthDakota" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchMississippi" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchMichigan" />
                  </NamedLink>
                </li>
              </ul>
            </div>
            <div className={css.searchesExtra} hidden>
              <ul className={css.list}>
                <li className={css.listItem}>
                  <NamedLink
                    name="SearchPage"
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchAlabama" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchKentucky" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchWisconsin" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchPennsylvania" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Footer.searchOklahoma" />
                  </NamedLink>
                </li>
              </ul>
            </div>
