...
export const NONSITEUSERS = "nonSiteUsers";
...
const EditListingWizardTab = props => {
  ...
  switch (tab) {
    ...
    case NONSITEUSERS: {
      const submitButtonTranslationKey = isNewListingFlow
        ? 'EditListingWizard.saveNewNonSiteUsers'
        : 'EditListingWizard.saveEditNonSiteUsers';
      return (
        <EditListingNonSiteUsersPanel
          {...panelProps(NONSITEUSERS)}
