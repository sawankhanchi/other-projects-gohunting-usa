...
export const BookingBreakdownComponent = props => {
  ...
  return (
    <div className={classes}>
      <LineItemBookingPeriod booking={booking} unitType={unitType} units={units} seats={seats} dateType={dateType} />
      <LineItemUnitsMaybe transaction={transaction} unitType={unitType} units={units} seats={seats}/>

      <LineItemBasePriceMaybe transaction={transaction} unitType={unitType} units={units} seats={seats} intl={intl} />

      <LineItemUnknownItemsMaybe transaction={transaction} isProvider={isProvider} units={units} seats={seats} intl={intl} />
