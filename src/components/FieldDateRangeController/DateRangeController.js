...
class DateRangeController extends Component {
  constructor(props) {
    ...
    this.state = {
      startDate: props.initializeStartDate ?  moment(props.initializeStartDate) : props.value && props.value.startDate ? moment(props.value.startDate) : null,
      endDate: props.initializeEndDate ?  moment(props.initializeEndDate) : props.value && props.value.endDate ? moment(props.value.endDate) : null,
  ...
  render() {
    ...
    const endDateFromForm = value && value.endDate ? moment(value.endDate) : null;
     ...
     const isSelected = initializeStartDate && initializeEndDate ? false : startDateFromState && endDateFromState;
