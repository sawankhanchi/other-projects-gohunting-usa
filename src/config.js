...
const bookingProcessSeasonalAlias = 'preauth-unit-booking/release-3';
...
const bookingUnitRegular = 'line-item/day';
const bookingUnitSeasonal = 'line-item/units';
...
const enableNonSiteUsers = process.env.REACT_APP_AVAILABILITY_ENABLED === 'true';
...
const dayCountAvailableForBooking = 365;
